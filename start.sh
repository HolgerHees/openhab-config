...
export JAVA_OPTS="${JAVA_OPTS} -Dgnu.io.rxtx.SerialPorts=/dev/ttyOpenHabLueftung:/dev/ttyOpenHabFunk -Xbootclasspath/a:${DIRNAME}/runtime/jython.jar -Dpython.home=${DIRNAME}/runtime -Dpython.path=${DIRNAME}/python"
