...
rawItems = {
    ...
    "pGF_Workroom_Air_Sensor_Temperature_Value": ["pGF_Workroom_Air_Sensor_Temperature_Raw", -0.1, -1.4],
    "pGF_Workroom_Air_Sensor_Humidity_Value": ["pGF_Workroom_Air_Sensor_Humidity_Raw", 2.6, 0.0],
    ...
    "pFF_Fitnessroom_Air_Sensor_Temperature_Value": ["pFF_Fitnessroom_Air_Sensor_Temperature_Raw", 0.0, -1.4],
    "pFF_Fitnessroom_Air_Sensor_Humidity_Value": ["pFF_Fitnessroom_Air_Sensor_Humidity_Raw", 1.1, 0.0],
    "pFF_Makeuproom_Air_Sensor_Temperature_Value": ["pFF_Makeuproom_Air_Sensor_Temperature_Raw", 0.1, -1.4],
    "pFF_Makeuproom_Air_Sensor_Humidity_Value": ["pFF_Makeuproom_Air_Sensor_Humidity_Raw", 2.8, 0.0],
