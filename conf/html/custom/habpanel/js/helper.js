        ...
        app.directive("mvTrigger", ["OHService","mvService","$rootScope", function (OHService,mvService,$rootScope)
        {
            ...
            return {
                ...
                link: function mvTriggerLink(scope, elem, attrs)
                {
                    ...
                    //    let testItem = {name: "pGF_Livingroom_Air_Sensor_Temperature_Value", state: "20.0"};
            ...
            return {
                ...
                link: function (scope, elem, attrs) 
                {
                    ...
                    function getSVG(icon_name)
                    {
                        ...
                        msg += "<use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"/static/custom/habpanel/svg/icons.svg#" + icon_name + "\"></use>";
                        msg += "</svg>";
                        return msg;
                    }
